...
if __name__ == "__main__":
    ...
    t = datetime.today()
    output_dir = results_dir + conf.dataset + t.strftime('%Y-%m-%d.%f')+'/'
    ...
    testing_size = common.count_images(conf.trainingset_path())
    ...
    if 'robust_reconstruction' in conf.testing:
        srange, mses, sers = flow.test_robust(conf, training)
    ...
    if 'robust_sampling' in conf.testing:
        srange, mses, sers = flow.test_robust_sampling(conf, training)
